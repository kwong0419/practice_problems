...
def has_path_sum(root, targetSum):
    ...
    targetSum -= root.val
    return (has_path_sum(root.left, targetSum) or
            has_path_sum(root.right, targetSum))
...
print(has_path_sum(root2, 5))  # Output: False

# Constructing the tree for Example 3
root3 = None
print(has_path_sum(root3, 0))  # Output: False
