...
def findTheDegreeOfEachVertex(matrix):
    n = len(matrix)
    ans = [0] * n
...
# Example Usage:
print(findTheDegreeOfEachVertex([[0,1,1],[1,0,1],[1,1,0]])) # [2,2,2]
print(findTheDegreeOfEachVertex([[0,1,0],[1,0,0],[0,0,0]])) # [1,1,0]
print(findTheDegreeOfEachVertex([[0]])) # [0]